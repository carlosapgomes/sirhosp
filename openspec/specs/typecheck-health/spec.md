# typecheck-health Specification

## Purpose

Define requirements for keeping the official typecheck gate actionable after
previously hidden mypy errors become visible.
