...
has occupancy greater than 100 percent, visible in the unit header without
expanding the unit body.
...
#### Scenario: Anonymous redirection remains with findings active
