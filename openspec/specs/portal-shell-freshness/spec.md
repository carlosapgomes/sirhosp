# portal-shell-freshness Specification

## Purpose

Define como o shell do portal (topbar presente em toda página autenticada)
comunica a atualidade da informação clínica: o badge de sincronização
exibe a hora da última **foto do censo** (`Max(CensusSnapshot.captured_at)`,
a mesma verdade do card "Última varredura completa" do dashboard), com
dot de idade, tooltip completo e refresh periódico via fragmento HTMX —
nunca derivado de `IngestionRun` individuais nem do horário do request.
