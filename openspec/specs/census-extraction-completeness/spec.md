...
Ensure census extractions are validated for sector coverage completeness
before any snapshot processing or batch creation, with safe aggregate
coverage metrics and conservative failure handling.
