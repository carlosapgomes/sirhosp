...
Sistema interno para extração automatizada de dados clínicos do sistema fonte hospitalar, armazenamento em banco paralelo PostgreSQL e oferta de consulta rápida, busca textual e resumos direcionados para gestão, qualidade, jurídico, diretoria e gestão de prontuários.
...
- não versionar dados reais de pacientes, credenciais, PDFs reais ou artefatos sensíveis
